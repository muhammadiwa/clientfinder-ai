...
const STRINGS = {
  ...
  scout: {
    ...
    sources: {
      ...
      googlePlacesDesc: "Places API (Sprint 3C) — bisnis terstruktur, rating, telepon",
      maps: "Google Maps",
      mapsDesc: "Playwright Chromium headless — bisnis, alamat, telepon",
      yelp: "Yelp Fusion",
      yelpDesc: "Bisnis dengan review (F&B, retail, klinik, salon)",
      tokopedia: "Tokopedia",
      tokopediaDesc: "Playwright — seller discovery di marketplace Indonesia",
      twitter: "Twitter / X",
  ...
  prospectDetail: {
    ...
    enrollments: {
      ...
      desc: "Drip outreach otomatis per prospek (R10 — semua pesan harus disetujui)",
      active: "aktif",
      empty: "Belum ada enrollment aktif",
      pickSequence: "Pilih sequence…",
      steps: "langkah",
      enroll: "Daftarkan",
      step: "Step",
      nextRun: "Berikutnya",
      ...
      resume: "Lanjutkan",
      stop: "Hentikan",
      runDrip: "Jalankan drip sekarang",
      historical: "riwayat",
      endedNormally: "selesai normal",
    },
  },
  ...
  sequences: {
    title: "Sequences",
    subtitle: "Drip outreach otomatis (R10 — operator tetap harus menyetujui pesan)",
    create: "Buat sequence",
    runDrip: "Jalankan drip sekarang",
    empty: "Belum ada sequence",
    emptyDesc: "Buat sequence baru untuk memulai",
    active: "aktif",
    inactive: "nonaktif",
    steps: "langkah",
    delete: "Hapus",
    confirmDelete: "Hapus sequence ini? Enrollment aktif akan tetap ada tapi tidak diproses lagi.",
    defaultName: "Drip 3-step",
